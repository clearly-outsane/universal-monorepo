        ...
        >
          <Image
            source={{
              width: 20,
              height: 20,
              uri: 'https://qwvsfvhphdefqfyuuhlb.supabase.co/storage/v1/object/public/logos/Google%20logo.png',
            }}
            width={20}
            height={20}
          />
        ...
        >
          <Image
            source={{
              width: 22,
              height: 22,
              uri: 'https://qwvsfvhphdefqfyuuhlb.supabase.co/storage/v1/object/public/logos/Apple%20logo.png',
            }}
            width={22}
            height={22}
            resizeMode="contain"
        ...
        >
          <Image
            source={{
              width: 25,
              height: 22,
              uri: 'https://qwvsfvhphdefqfyuuhlb.supabase.co/storage/v1/object/public/logos/Discord%20logo.png',
            }}
            width={25}
            height={22}
            resizeMode="contain"
